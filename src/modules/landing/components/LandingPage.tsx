    ...
    <div className="min-h-screen theme-gradient transition-all duration-700">
      ...
      <main className="max-w-7xl mx-auto px-4 py-20 relative">
        ...
        >
          ...
          >
            Each project showcases different technologies, patterns, and problem-solving approaches. From AI integrations to SaaS platforms, exploring the full spectrum of modern web development.
          </motion.p>
          <motion.p
            variants={fadeInUp}
            className="text-sm text-white/50 mb-6 md:mb-8"
          >
            Built with Next.js, TypeScript, Tailwind CSS, and production-ready architecture.
          </motion.p>
          <motion.div variants={fadeInUp}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="secondary" asChild>
                <Link href="#showroom">Explore Components</Link>
              </Button>
            </div>
          </motion.div>
        </motion.div>
